...
from auto_rotater import AutoRotator, RotationParameters
...
class GridParameters:
    ...
    Attributes:
        ...
        auto_rotate (bool): Automatically rotate the image based on detected midline.
    """
    image_path: str
...
class ImageGridder:
    ...
    def __init__(self, params: GridParameters):
        ...
        self.rotator = AutoRotator(RotationParameters(
    ...
    def process(self) -> str:
        ...
        aligned_tensor = self.rotator.detect_and_adjust_midline(cropped_tensor)
        grid_tensor = self.add_grid(aligned_tensor)
    ...
    def _load_image(self):
        ...
        try:
            image = Image.open(self.params.image_path)
            if image.size == (0, 0):
            ...
            if torch.isinf(self.image_tensor).any():
...
def parse_args() -> GridParameters:
    ...
    parser.add_argument('--auto-rotate', action='store_true', help='Automatically rotate the image')
